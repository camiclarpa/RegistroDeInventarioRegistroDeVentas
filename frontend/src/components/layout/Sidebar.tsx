...
import {
  ...
  ChevronRight, Bike, Users, Tag, Settings, Printer
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { label: 'CRM', path: '/crm', icon: <Users />, roles: ['ADMIN', 'SELLER'] },
  ...
  { label: 'Etiquetas', path: '/labels', icon: <Printer />, roles: ['ADMIN', 'WAREHOUSE'] },
...
export const Sidebar = () => {
  ...
  useEffect(() => {
    // Lógica de branding si es necesaria
  }, []);
